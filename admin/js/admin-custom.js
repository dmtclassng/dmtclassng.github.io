...
NOTE: This file contains all scripts for the Admin Template. There are some more scripts which we used from base template. You can check it in base template custom.js file.
